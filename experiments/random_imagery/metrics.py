"""Shared metrics and subject-cluster uncertainty for random-imagery models."""
...
class PredictionMetrics:
    ...
    @property
    def per_pixel_score_mse(self) -> NDArray[np.float64]:
        return self.per_pixel_brier_score

    @property
    def mean_score_mse(self) -> float:
        return self.mean_brier_score
